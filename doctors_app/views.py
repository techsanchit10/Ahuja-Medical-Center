...
from doctors_app.models import UserProfileInfo2
...
def doctor_pt(request):
    return render(request,'hospital_temp/dp.html')

def appointment_d(request):
    hii=UserProfileInfo2.objects.all()
    return render(request,'hospital_temp/appointment_d.html',{'hii':hii})
